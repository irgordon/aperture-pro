...
(function () {
    ...
    function handleError(error) {
        console.error('Aperture Pro Error:', error);
    ...
    async function loadProofingGallery(container) {
    ...
    async function submitProofing(projectId) {
        try {
    ...
    async function unlockProofing(projectId, btn) {
        setLoading(btn, true);
        try {
            await post(`projects/${projectId}/proofing/unlock`);
            toast('Proofing unlocked');
            location.reload();
        } catch (e) {
            handleError(e);
        } finally {
    ...
    async function completeProofing(projectId, btn) {
        setLoading(btn, true);
        try {
            await post(`projects/${projectId}/proofing/complete`);
            toast('Proofing completed');
            location.reload();
        } catch (e) {
            handleError(e);
        } finally {
    ...
    async function generateZip(projectId, btn) {
        setLoading(btn, true);
        try {
            await post(`projects/${projectId}/delivery/generate-zip`);
            toast('ZIP generation started');
        } catch (e) {
            handleError(e);
        } finally {
            setLoading(btn, false);
    ...
    async function sendDeliveryLink(projectId, btn) {
        setLoading(btn, true);
        try {
            await post(`projects/${projectId}/delivery/send-link`);
            toast('Delivery link sent');
        } catch (e) {
            handleError(e);
        } finally {
            setLoading(btn, false);
    ...
    document.addEventListener('click', (e) => {
        ...
        switch (action) {
            ...
            case 'complete-proofing':
                completeProofing(projectId, btn);
                break;

            case 'generate-zip':
                generateZip(projectId, btn);
                break;

            case 'send-delivery-link':
                sendDeliveryLink(projectId, btn);
                break;
        }
    });
    ...
    document.addEventListener('click', (e) => {
        ...
        const container = btn.closest('#ap-proofing-gallery');
    ...
    // ------------------------------------------------------------
    // Auto‑hydrate proofing gallery
    // ------------------------------------------------------------

    document.addEventListener('DOMContentLoaded', () => {
        const gallery = qs('#ap-proofing-gallery');
        if (gallery) {
            loadProofingGallery(gallery);
        }
    });
})();
